...
RecvSerialPort::RecvSerialPort(QObject *parent) : QSerialPort(parent)
{
    // 建立连接
       connect(this, &RecvSerialPort::readyRead,
               this, &RecvSerialPort::readMessage);
...
// 发送数据
void RecvSerialPort::sendMessage(QByteArray ba)
{
...
// 接收数据
void RecvSerialPort::readMessage()
{
    QByteArray data;
...
// 解析
void RecvSerialPort::rxDataHandle(char data)
{
    // 状态机
